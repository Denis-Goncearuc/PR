...
public class HTTPRequest {
    ...
    public HTTPRequest(String url, RequestType requestType) throws IOException {
        Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("p.webshare.io", 20000));
        this.url = new URL(url).openConnection(proxy);
        this.requestType = requestType;

        this.inputStream = null;
        this.parameters = new HashMap<>();
        this.connection = (HttpURLConnection) this.url;
